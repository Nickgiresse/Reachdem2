  ...
  items = [
    ...
    },
    {
      ...
      answer: (
        <>
          <p className="text-muted-foreground mb-4 max-w-[580px]">
            {"Actually, yes! I&apos;m always acively looking for beta testers of new features. If you are interested in exchanging feedback for discount, please contact me via "}
            <a
